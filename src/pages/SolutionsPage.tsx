...
export default function SolutionsPage() {
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-accent-primary via-accent-secondary to-secondary-blue text-white py-[var(--space-128)] px-[var(--space-24)]">
        <div className="container mx-auto text-center">
          ...
          <p className="text-[length:var(--text-body-large)] mb-[var(--space-48)] max-w-3xl mx-auto opacity-90 font-sans">
            ...
            {solutionCategories.map((category, index) => (
              <Card key={index} className="group hover:shadow-xl transition-all duration-300 border-gray-800 hover:border-yellow-400/30 glow-gold-subtle bg-gray-900">
                <CardContent className="p-[var(--space-32)]">
                  <div className={`inline-flex p-[var(--space-16)] rounded-lg bg-gradient-to-r ${category.color} text-white mb-[var(--space-24)]`}>
                    {category.icon}
                  </div>
                  ...
                  <p className="text-gray-400 mb-[var(--space-24)] leading-relaxed font-sans">
                    {category.description}
                  </p>
                  
                  <ul className="space-y-[var(--space-8)] mb-[var(--space-32)]">
